...
def save_menu(request):
    if request.method == 'POST':
        ...
        menu_course_type = request.POST.get('menu_course_type')
        ...
        menu, create = Menu.objects.get_or_create(date=date, menu_course_type=menu_course_type, main_dish=main_dish)
